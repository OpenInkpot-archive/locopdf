...
void
choicebox_change_selection(Evas * e, Evas_Object * obj, int new_navsel)
{
...
void
choicebox_next_page(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct;
    infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
    ...
    for (int i = 0; i < noptions; i++) {
        ...
        if (i < shownum) {
            edje_object_part_text_set(choicelabel, "dlg_optionlabel/text",
                                      infostruct->choices[infostruct->
                                                          curindex + i]);
            if (valuelabel)
                edje_object_part_text_set(valuelabel,
                                          "dlg_valuelabel/text",
                                          infostruct->values[infostruct->
                                                             curindex +
                                                             i]);
        } else {
            edje_object_part_text_set(choicelabel, "dlg_optionlabel/text",
    ...
    if (infostruct->numchoices > noptions) {
        char *p;
        asprintf(&p, "Page %d of %d", 1 + infostruct->curindex / 8,
                 (7 + infostruct->numchoices) / 8);
...
void
choicebox_previous_page(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct;
    infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
void
choicebox_esc(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
void
choicebox_item(Evas * e, Evas_Object * obj, int index, bool lp)
{
    choice_info_struct *infostruct;
    if (index >= 1 && index <= 8) {
        int curchoice;
        infostruct =
            (choice_info_struct *) evas_object_data_get(obj,
                                                        "choice_info");
...
void
choicebox_nav_up(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
void
choicebox_nav_down(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
void
choicebox_nav_left(Evas * e, Evas_Object * obj)
{
    choicebox_previous_page(e, obj);
}

void
choicebox_nav_right(Evas * e, Evas_Object * obj)
{
    choicebox_next_page(e, obj);
}

void
choicebox_nav_sel(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
Evas_Object *
init_choicebox(Evas * evas, const char *choicelist[], const char *values[],
               int numchoices, choice_handler handler, char *header,
               Evas_Object * parent, void *userdata)
{
    ...
    for (int i = 0; i < numchoices; i++) {
        ...
        if (values) {
            info->values[i] =
                (char *) malloc(sizeof(char) * (strlen(values[i]) + 1));
    ...
    evas_object_table_homogeneous_set(maintable,
    ...
    info->choicelabels =
        (Evas_Object **) malloc(sizeof(Evas_Object *) * noptions);
    if (values)
        info->valuelabels =
            (Evas_Object **) malloc(sizeof(Evas_Object *) * noptions);
    else
...
void
free_choices(choice_info_struct * infostruct)
{
...
void
fini_choicebox(Evas * e, Evas_Object * obj)
{
    bool master = false;
    choice_info_struct *infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
Evas_Object *
choicebox_get_parent(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct;
    infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
void *
choicebox_get_userdata(Evas * e, Evas_Object * obj)
{
    choice_info_struct *infostruct;
    infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");
...
void
update_label(Evas * e, Evas_Object * obj, int number, const char *value)
{
    choice_info_struct *infostruct;
    infostruct =
        (choice_info_struct *) evas_object_data_get(obj, "choice_info");

    edje_object_part_text_set(infostruct->valuelabels[number],
                              "dlg_valuelabel/text", value);
