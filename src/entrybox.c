...
void
entrybox_ok(Evas * e, Evas_Object * obj)
{
...
void
entrybox_esc(Evas * e, Evas_Object * obj)
{
    entry_info_struct *infostruct =
        (entry_info_struct *) evas_object_data_get(obj, "entry_info");
    if (infostruct->curchar > 0) {
        ...
        edje_object_part_text_set(obj, "dlg_entrybox/entrytext",
                                  infostruct->entry);
    } else {
        evas_object_focus_set(infostruct->parent, 1);
...
void
entrybox_item(Evas * e, Evas_Object * obj, int index, bool lp)
{
...
Evas_Object *
init_entrybox(Evas * evas, const char *title, const char *defaultentry,
              int maxlength, entry_handler handler, Evas_Object * parent)
{
...
void
fini_entrybox(Evas * e, Evas_Object * obj)
{
    evas_object_del(obj);
}
...
Evas_Object *
entrybox_get_parent(Evas * e, Evas_Object * obj)
{
    entry_info_struct *infostruct;
    infostruct =
        (entry_info_struct *) evas_object_data_get(obj, "entry_info");
